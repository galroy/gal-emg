...
void SetITCToR2C(){
	...
	HAL_I2C_Mem_Write(&hi2c1, 0XD0, 0, 1, arrData, 7, 0XFF);

 }
void GetITCToR2C(int to){
	uint8_t arrData[7];
	HAL_I2C_Mem_Read(&hi2c1, 0XD0, 0,  1, arrData, 7, 0XFF);
	for(int i = 0;i<to;i++){
		printf("%u",arrData[i]);
	}
	printf("\r\n");
